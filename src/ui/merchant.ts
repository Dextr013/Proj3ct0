import { EquipmentItem, EquipmentSlot, GameState, Rarity } from '../core/types';
import { applyUpgrade, upgradeCostCrystals, upgradeCostGold } from '../game/economy';

function sampleItems(): EquipmentItem[] {
  return [
...
export function renderMerchant(state: GameState, listEl: HTMLElement, onClose: () => void): void {
  listEl.innerHTML = '';
